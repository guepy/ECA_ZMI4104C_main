...
"color: red;\n"
"}"));
        vWidget_2 = new QWidget(CEsettingsForm);
        vWidget_2->setObjectName(QString::fromUtf8("vWidget_2"));
        vWidget_2->setGeometry(QRect(20, 40, 471, 181));
...
"font: 75 12pt \"MS Shell Dlg 2\";"));
        ...
        radioButton = new QRadioButton(vWidget_2);
...
"font: 75 12pt \"MS Shell Dlg 2\";"));
        ...
        lineEdit_11->setMinimumSize(QSize(180, 35));

        horizontalLayout_13->addWidget(lineEdit_11);

        pushButton = new QPushButton(vWidget_2);
        ...
        lineEdit_12->setMinimumSize(QSize(180, 35));

        horizontalLayout_14->addWidget(lineEdit_12);

        pushButton_3 = new QPushButton(vWidget_2);
        ...
        lineEdit_13->setMinimumSize(QSize(180, 35));

        horizontalLayout_15->addWidget(lineEdit_13);

        pushButton_4 = new QPushButton(vWidget_2);
        ...
        vWidget_3 = new QWidget(CEsettingsForm);
        vWidget_3->setObjectName(QString::fromUtf8("vWidget_3"));
        vWidget_3->setGeometry(QRect(20, 470, 471, 201));
...
"}"));
        ...
        lineEdit_14 = new QLineEdit(vWidget_3);
        ...
        lineEdit_15 = new QLineEdit(vWidget_3);
        ...
        lineEdit_16 = new QLineEdit(vWidget_3);
        ...
        vWidget_4 = new QWidget(CEsettingsForm);
        vWidget_4->setObjectName(QString::fromUtf8("vWidget_4"));
        vWidget_4->setGeometry(QRect(20, 240, 471, 211));
        vWidget_4->setStyleSheet(QString::fromUtf8("#vWidget_4{\n"
"border: 1px solid;\n"
"}"));
        ...
        lineEdit_17 = new QLineEdit(vWidget_4);
        lineEdit_17->setObjectName(QString::fromUtf8("lineEdit_17"));
        sizePolicy.setHeightForWidth(lineEdit_17->sizePolicy().hasHeightForWidth());
        lineEdit_17->setSizePolicy(sizePolicy);
        lineEdit_17->setMinimumSize(QSize(180, 35));

        horizontalLayout_19->addWidget(lineEdit_17);
        ...
        lineEdit_18 = new QLineEdit(vWidget_4);
        lineEdit_18->setObjectName(QString::fromUtf8("lineEdit_18"));
        sizePolicy.setHeightForWidth(lineEdit_18->sizePolicy().hasHeightForWidth());
        lineEdit_18->setSizePolicy(sizePolicy);
        lineEdit_18->setMinimumSize(QSize(180, 35));

        horizontalLayout_20->addWidget(lineEdit_18);
        ...
        lineEdit_19 = new QLineEdit(vWidget_4);
        lineEdit_19->setObjectName(QString::fromUtf8("lineEdit_19"));
        sizePolicy.setHeightForWidth(lineEdit_19->sizePolicy().hasHeightForWidth());
        lineEdit_19->setSizePolicy(sizePolicy);
        lineEdit_19->setMinimumSize(QSize(180, 35));

        horizontalLayout_21->addWidget(lineEdit_19);
        ...
        ButtonForm->setGeometry(QRect(20, 690, 681, 51));
...
"color: white;"));
    ...
    void retranslateUi(QWidget *CEsettingsForm)
    {
        ...
        label_8->setText(QCoreApplication::translate("CEsettingsForm", "CE0", nullptr));
        pushButton->setText(QCoreApplication::translate("CEsettingsForm", "Reset", nullptr));
        label_12->setText(QCoreApplication::translate("CEsettingsForm", "CE N", nullptr));
        pushButton_3->setText(QCoreApplication::translate("CEsettingsForm", "Reset", nullptr));
        label_13->setText(QCoreApplication::translate("CEsettingsForm", "Meas", nullptr));
        ...
        label_10->setText(QCoreApplication::translate("CEsettingsForm", "CE 0 Min Vel", nullptr));
        pushButton_6->setText(QCoreApplication::translate("CEsettingsForm", "Default", nullptr));
        label_16->setText(QCoreApplication::translate("CEsettingsForm", "CE N Max Vel", nullptr));
