...
QT_MOC_LITERAL(8, 8), // "openThis"
QT_MOC_LITERAL(17, 0), // ""
QT_MOC_LITERAL(18, 9) // "closeThis"

    },
    "MySlots\0openThis\0\0closeThis"
};
...
void MySlots::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySlots::openThis)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MySlots::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySlots::closeThis)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MySlots::openThis()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MySlots::closeThis()
{
