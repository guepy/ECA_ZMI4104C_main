...
"}"));
        ...
        label_15 = new QLabel(horizontalWidget_21);
        ...
        comboBox_2->setMinimumSize(QSize(50, 35));
...
"font: 75 12pt \"MS Shell Dlg 2\";"));
    ...
    void retranslateUi(QWidget *FlyscanForm)
    {
        ...
        label_15->setText(QCoreApplication::translate("FlyscanForm", "Mode", nullptr));
        comboBox_2->setItemText(0, QCoreApplication::translate("FlyscanForm", "Auto", nullptr));
        comboBox_2->setItemText(1, QCoreApplication::translate("FlyscanForm", "Manual", nullptr));
